...
$( document ).ready(function() {
                ...
                .done(function(json){
                    ...
                    if(json[0].Titolo!=undefined){
                        var div1="<div class=\"col-lg-6 col-sm-6 col-xs-12\"><a href=\"/assistenza.html?type=assistenza&codice="+json[0].Assistenza_idAssistenza+"\" style=\"text-decoration: none\"><div class=\"assistenza\"><h4 class=\"prova\">"+json[0].Titolo+"<div class=\"pull-right\"><span class=\"glyphicon glyphicon-circle-arrow-right\"></span></div></h4></div></a></div>"
                        ...
                        for(i=1;i<json.length;i++)
                        {
                            ...
                            if (verifica!=0){
                                var div1="<div class=\"col-lg-6 col-sm-6 col-xs-12\"><a href=\"/assistenza.html?type=assistenza&codice="+json[y].Assistenza_idAssistenza+"\"  style=\"text-decoration: none\"><div class=\"assistenza\"><h4 class=\"prova\">"+json[y].Titolo+"<div class=\"pull-right\"><span class=\"glyphicon glyphicon-circle-arrow-right\"></span></div></h4></div></a></div>"
                                $("#cicloassistenza").append(div1);
