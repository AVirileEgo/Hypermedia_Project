			...
			$( document ).ready(function() {
                ...
                .done(function(json){
                    ...
                    for(i=4;i<8;i++){
                     ...
                     var div= "<div class=\"col-lg-3 col-sm-3 col-xs-6\" style=\"background: transparent\" ><div class=\"bordo\" style=\"min-height:340px;\"><div class=\"immagine\"><a href=\"/Prodotto.html?type=smartphone&prodotto="+json[i].idProdotto+"\"><img class=\"flex zoom2\" style=\"border:0px;\"src=\"img/Prodotti/"+json[i].IMG_FRONT+"\" ></a></div><p class=\"nome\"><b>"+json[i].Nome+"</b></p><p class=\"prezzo\">"+json[i].Prezzo+" €</p></div></div>"
                    $("#elenco2").append(div);
                    }
